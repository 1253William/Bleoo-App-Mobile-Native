      ...
      <ScrollView className="flex-1">
        ...
        <View className="flex-row items-center px-4 py-3 bg-white">
          ...
          <View className="flex-row items-center ml-4">
            ...
            />
            <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-base font-semibold">{user.fullName}</Text>
          </View>
        </View>
        ...
        <View className="flex-row px-4 mb-4">
          <View className="mr-8">
            ...
            <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-black text-base font-semibold">{user.followers || '100'}</Text>
          </View>
          <View>
            <Text style={{fontFamily: 'Gilroy-Regular'}} className="text-gray-500 text-md">Following</Text>
            <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-black text-base font-semibold">{user.following || '50'}</Text>
          </View>
        </View>
        ...
        <View className="px-4 mb-4">
          <View className="flex-row items-center justify-between mb-1">
            <View className="flex-1">
              <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-lg font-semibold text-black">{user.fullName}</Text>
              <Text style={{fontFamily: 'Gilroy-Regular'}} className="text-gray-500 text-md">{user.email || '@joshuser'}</Text>
            </View>
            <View className="flex-row items-center bg-yellow-100 px-3 py-2 rounded-full">
              <Text style={{fontFamily: 'Gilroy-Regular'}} className="text-yellow-700 text-md font-medium mr-1">Bleoo {user.yearGroup}</Text>
